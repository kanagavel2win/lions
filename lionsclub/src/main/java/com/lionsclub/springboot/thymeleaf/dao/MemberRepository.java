...
public interface MemberRepository extends JpaRepository<Member, Integer> {
	...
	@Query("Select m From Member m where m.Family_Unit ='Family Unit Member'  and m.deletedStatus = false ")
	public List<Member> getFamilyMemberDetails(@Param("MemberID") String MemberID);

	@Query("Select m From Member m where m.Family_Unit ='Head of Household'  and m.deletedStatus = false ")
	public List<Member> getHouseholderdetails();
	
	@Query("Select m.MemberID From Member m where  m.deletedStatus = false ")
